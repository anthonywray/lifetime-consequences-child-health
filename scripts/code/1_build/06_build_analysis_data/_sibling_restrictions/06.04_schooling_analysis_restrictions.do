/***** 06.03_schooling_analysis_restrictions.do
...
quietly {
	...
	gen insample = (scholar != . & `scholar_restrictions' == 1)
	...
	* Drop households with multiple patients
	...
	gen insample = (scholar != . & base_sample == 1 & flag_extra_sibpat == 0 & `scholar_restrictions' == 1)
	egen `samp_pat'
	egen `samp_sib'	
