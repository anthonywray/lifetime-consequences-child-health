/***** 06.02_occupational_analysis_restrictions.do
...
quietly {
	...
	gen insample = (`occupation_restrictions' == 1) 
	...
	* Drop households with multiple patients
	...
	gen insample = (base_sample == 1 & flag_extra_sibpat == 0 & `occupation_restrictions' == 1)
	egen `samp_pat'
	egen `samp_sib'	
